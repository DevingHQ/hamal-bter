...
export default class {
  constructor({key, secret, version = '1'}) {
    ...
    this._hasher = crypto.createHmac('sha512', secret);
  ...
  sell(rate, amount, pair) {
    ...
    return this._post(api, {pair, rate, amount});
  }
  ...
  _signature(form = {}) {
    ...
    return this._hasher.update(temp).digest('hex');
  }
